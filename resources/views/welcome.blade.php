...
<head>
    ...
    <link rel="apple-touch-icon" href="{{url('/')}}/appy/images/apple-touch-icon.png">
    <link rel="shortcut icon" type="image/ico" href="{{url('/')}}/appy/images/favicon.ico" />
    <!-- Plugin-CSS -->
    <link rel="stylesheet" href="{{url('/')}}/appy/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{url('/')}}/appy/css/owl.carousel.min.css">
    <link rel="stylesheet" href="{{url('/')}}/appy/css/linearicons.css">
    <link rel="stylesheet" href="{{url('/')}}/appy/css/magnific-popup.css">
    <link rel="stylesheet" href="{{url('/')}}/appy/css/animate.css">
    <!-- Main-Stylesheets -->
    <link rel="stylesheet" href="{{url('/')}}/appy/css/normalize.css">
    <link rel="stylesheet" href="{{url('/')}}/appy/style.css">
    <link rel="stylesheet" href="{{url('/')}}/appy/css/responsive.css">
    <script src="{{url('/')}}/appy/js/vendor/modernizr-2.8.3.min.js"></script>
    <!--[if lt IE 9]>
...
<body data-spy="scroll" data-target=".mainmenu-area">
    ...
    <nav class="mainmenu-area" data-spy="affix" data-offset-top="200">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="{{url('/')}}/appy/images/logo.png" alt="Logo"></a>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 hidden-sm col-md-5">
                    <figure class="mobile-image wow fadeInUp" data-wow-delay="0.2s">
                        <img src="{{url('/')}}/appy/images/header-mobile.png" alt="">
                    </figure>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    <div class="page-title text-center">
                        <img src="{{url('/')}}/appy/images/about-logo.png" alt="About Logo">
                        <div class="space-20"></div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <figure class="mobile-image">
                        <img src="{{url('/')}}/appy/images/progress-phone.png" alt="">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    <div class="video-photo">
                        <img src="{{url('/')}}/appy/images/video-image.jpg" alt="">
                        <a href="https://www.youtube.com/watch?v=ScrDhTsX0EQ" class="popup video-button">
                            <img src="{{url('/')}}/appy/images/play-button.png" alt="">
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="hidden-xs hidden-sm col-md-4">
                    <figure class="mobile-image">
                        <img src="{{url('/')}}/appy/images/feature-image.png" alt="Feature Photo">
                    </figure>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="team-slide">
                        <div class="team-box">
                            <div class="team-image">
                                <img src="{{url('/')}}/appy/images/team-1.png" alt="">
                            </div>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="{{url('/')}}/appy/images/team-2.jpg" alt="">
                            </div>
                            <h4>Ashekur Rahman</h4>
                            <h6 class="position">Art Dirrector</h6>
                            <p>Lorem ipsum dolor sit amet, conseg sed do eiusmod temput laborelaborus ed sed do eiusmod tempo.</p>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="{{url('/')}}/appy/images/team-3.jpg" alt="">
                            </div>
                            <h4>Ashekur Rahman</h4>
                            <h6 class="position">Art Dirrector</h6>
                            <p>Lorem ipsum dolor sit amet, conseg sed do eiusmod temput laborelaborus ed sed do eiusmod tempo.</p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 gallery-slider">
                    <div class="gallery-slide">
                        <div class="item"><img src="{{url('/')}}/appy/images/gallery-1.jpg" alt=""></div>
                        <div class="item"><img src="{{url('/')}}/appy/images/gallery-2.jpg" alt=""></div>
                        <div class="item"><img src="{{url('/')}}/appy/images/gallery-3.jpg" alt=""></div>
                        <div class="item"><img src="{{url('/')}}/appy/images/gallery-4.jpg" alt=""></div>
                        <div class="item"><img src="{{url('/')}}/appy/images/gallery-1.jpg" alt=""></div>
                        <div class="item"><img src="{{url('/')}}/appy/images/gallery-2.jpg" alt=""></div>
                        <div class="item"><img src="{{url('/')}}/appy/images/gallery-3.jpg" alt=""></div>
                        <div class="item"><img src="{{url('/')}}/appy/images/gallery-1.jpg" alt=""></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 hidden-sm">
                    <figure class="mobile-image">
                        <img src="{{url('/')}}/appy/images/download-image.png" alt="">
                    </figure>
                </div>
                <div class="col-xs-12 col-md-6 section-padding">
                    ...
                    <div class="space-60"></div>
                    <a href="#" class="bttn-white sq"><img src="{{url('/')}}/appy/images/apple-icon.png" alt="apple icon"> Apple Store</a>
                    <a href="#" class="bttn-white sq"><img src="{{url('/')}}/appy/images/play-store-icon.png" alt="Play Store Icon"> Play Store</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Footer-Area-End -->
    <!--Vendor-JS-->
    <script src="{{url('/')}}/appy/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="{{url('/')}}/appy/js/vendor/jquery-ui.js"></script>
    <script src="{{url('/')}}/appy/js/vendor/bootstrap.min.js"></script>
    <!--Plugin-JS-->
    <script src="{{url('/')}}/appy/js/owl.carousel.min.js"></script>
    <script src="{{url('/')}}/appy/js/contact-form.js"></script>
    <script src="{{url('/')}}/appy/js/ajaxchimp.js"></script>
    <script src="{{url('/')}}/appy/js/scrollUp.min.js"></script>
    <script src="{{url('/')}}/appy/js/magnific-popup.min.js"></script>
    <script src="{{url('/')}}/appy/js/wow.min.js"></script>
    <!--Main-active-JS-->
    <script src="{{url('/')}}/appy/js/main.js"></script>
</body>
